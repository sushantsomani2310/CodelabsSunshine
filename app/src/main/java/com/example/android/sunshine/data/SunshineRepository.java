...
import com.example.android.sunshine.data.database.IWeatherDao;
...
public class SunshineRepository {
    ...
    private final IWeatherDao mWeatherDao;
    private final WeatherNetworkDataSource mWeatherNetworkDataSource;
    private final AppExecutors mExecutors;
    private boolean mInitialized = false;

    private SunshineRepository(IWeatherDao weatherDao,
    ...
    public synchronized static SunshineRepository getInstance(
            IWeatherDao weatherDao, WeatherNetworkDataSource weatherNetworkDataSource,
            AppExecutors executors) {
    ...
    public LiveData<List<WeatherEntry>> getCurrentWeatherForecasts(){
        initializeData();
        java.sql.Date today= SunshineDateUtils.getNormalizedUtcDateForToday();
